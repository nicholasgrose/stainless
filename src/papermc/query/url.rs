use crate::{PaperMCServerApp, ServerApplication};
...
pub fn papermc_project_download_url(server_app: &PaperMCServerApp) -> String {
    format!("{}/downloads/{}", papermc_project_build_url(&server_app.project, &server_app.build), server_app.application_name())
}
